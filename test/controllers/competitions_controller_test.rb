...
class CompetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post competitions_url, params: { competition: { country: @competition.country, date: @competition.date, distance_type: @competition.distance_type, location: @competition.location, name: @competition.name } }
    end
  ...
  test "should update competition" do
    patch competition_url(@competition), params: { competition: { country: @competition.country, date: @competition.date, distance_type: @competition.distance_type, location: @competition.location, name: @competition.name } }
