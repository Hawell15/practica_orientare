...
class RunnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create runner" do
    assert_difference('Runner.count') do
      post runners_url, params: { runner: { category: @runner.category, club: @runner.club, dob: @runner.dob, gender: @runner.gender, name: @runner.name, surname: @runner.surname } }
    end
  ...
  test "should update runner" do
    patch runner_url(@runner), params: { runner: { category: @runner.category, club: @runner.club, dob: @runner.dob, gender: @runner.gender, name: @runner.name, surname: @runner.surname } }
